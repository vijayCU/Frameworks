...
public class TableBasic2 {
	...
	public static void main(String[] args) {
		...
		List<WebElement> allcells = driver.findElements(By.xpath("//tr"));//complete table xpath //th|//td
		Iterator<WebElement> li = allcells.iterator();
		
		//print the content of all cell
