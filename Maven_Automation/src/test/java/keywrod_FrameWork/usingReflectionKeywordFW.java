...
class MyActions{
	...
	public static void VerifyElementPresent(WebDriver driver,String xpath,String input)
	{
		...
		System.out.println("Element is present: PASS");
		}
		catch(Exception e)
		{
			System.out.println("Element is Not present: FAIL");
		}
	}
}

public class usingReflectionKeywordFW {
	...
	public static void doAction(WebDriver driver,String xpath,String action,String input) throws Exception 
	{
//		Method[] allMethods = MyActions.class.getDeclaredMethods();
//		for(Method method:allMethods)
//		{
//			String methodName = method.getName();
//			if(methodName.equalsIgnoreCase(action))
//			{
//				method.invoke(null,driver,xpath,input);
//			}
//			
//		}
		Method method = MyActions.class.getDeclaredMethod(action, WebDriver.class,String.class,String.class);
		method.invoke(null, driver,xpath,input);
		Thread.sleep(1000);
	}
